    ...
    <div class="hero container">
        <div class="inner">
            <div class="image-wrapper">
                ...
                <div class="text">
                    <h1>Hirdmann <span class="block small">Custom Upholstery & Bags</span></h1>
                </div>
            </div>
<!--            <div class="swiper">-->
<!--                <div class="swiper-wrapper">-->
<!--                     Image Slides -->
<!--                    <div class="swiper-slide"><img src="/assets/images/hirdmann-hero-1.jpg"></div>-->
<!--                    <div class="swiper-slide"><img src="/assets/images/hirdmann-hero-2.jpg"></div>-->
<!--                    <div class="swiper-slide"><img src="/assets/images/hirdmann-hero-1.jpg"></div>-->
<!--                </div>-->
<!--            </div>-->
        </div>
